...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _containers_root__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./containers/root */ \"./src/containers/root/index.jsx\");\n\n\nfunction handleReady() {\n  var rootContainer = React.createElement(_containers_root__WEBPACK_IMPORTED_MODULE_0__[\"default\"], null);\n  var $app = document.querySelector('#app');\n  ReactDOM.render(rootContainer, $app);\n}\n\nif (/complete|interactive|loaded/.test(document.readyState)) {\n  handleReady();\n} else {\n  document.addEventListener('DOMContentLoaded', handleReady);\n}\n\n//# sourceURL=webpack:///./src/index.jsx?");
